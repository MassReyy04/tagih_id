...
class StoreMonitoringPenagihanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'signature_mitra' => ['required', 'string'],
            'signature_petugas' => ['required', 'string'],
        ];
    }
    ...
    {
        return [
            'signature_mitra.required' => 'Tanda tangan mitra binaan wajib diisi.',
            'signature_petugas.required' => 'Tanda tangan petugas wajib diisi.',
        ];
    }
}
